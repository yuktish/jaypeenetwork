...
class Contact extends Component{
    constructor(props){
        ...
        //"no longer needed managed by react-redux-form" this.handleInputChange=this.handleInputChange.bind(this);
    }
    ...
    validate(firstname,lastname,telnum,email){
        ...
        if(this.state.touched.telnum && !reg.test(telnum))
            errors.telnum='Telephone number can be numeric only';
    ...
    render(){
        ...
        //"managed by react-redux-form" const errors=this.validate(this.state.firstname,this.state.lastname,this.state.telnum,this.state.email);
            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                            ...
                            Guna<br />
                            <i className="fa fa-phone"></i>: +91 12340 56780<br />
                            <i className="fa fa-fax"></i>: +91 87650 43210<br />
                            <i className="fa fa-envelope"></i>: <a href="mailto:jaypeenetwork.ac.in">jaypeenetwork.ac.in</a>
                            </address>
                    </div>
